...
sudo pacman -S --needed --noconfirm git base-devel sudo pacman -S waybar hyprlock kitty rofi fastfetch
...
yay -S --noconfirm swww pywal swaync wofi ttf-monocraft noto-fonts-cjk otf-codenewroman-nerd
